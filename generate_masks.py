...
import cv2
from models import UNet16, LinkNet34, UNet11, UNet, AlbuNet, TernausNetV2, RasTerNetV2, TernausNetOC #DeeperNetV3
import torch
...
if __name__ == '__main__':
    ...
    arg('--model_type', type=str, default='UNet', help='network architecture',
        choices=['UNet', 'UNet11', 'UNet16', 'LinkNet34', 'AlbuNet', 'TernausNetV2', 'RasTerNetV2', 'TernausNetOC'])
